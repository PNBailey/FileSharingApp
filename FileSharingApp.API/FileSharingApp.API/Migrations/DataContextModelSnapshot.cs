...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FileSharingApp.API.BaseFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileSharingApp.API.FileType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileSharingApp.API.Models.Folders.Folder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FileSharingApp.API.BaseFile", b =>
                {
                    ...
                    b.HasOne("FileSharingApp.API.FileType", "FileType")
                        .WithMany()
                        .HasForeignKey("FileTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FileSharingApp.API.Models.Folders.Folder", "Folder")
                        .WithMany("Files")
            ...
            modelBuilder.Entity("FileSharingApp.API.Models.Folders.Folder", b =>
                {
                    ...
                    b.HasOne("FileSharingApp.API.Models.Folders.Folder", "ParentFolder")
                        .WithMany("SubFolders")
